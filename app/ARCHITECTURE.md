...
`localStorage` under `mock-interview-bookmarks` for saved questions and the user's own pasted
key. Closing the tab ends the interview; bookmarks outlive it.
...
against the same assignment across models. Findings there do not reach here automatically — see
